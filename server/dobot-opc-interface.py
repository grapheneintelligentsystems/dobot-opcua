...
if __name__ == "__main__":
    ...
    connectCommand = commandListNode.get_child(["0:Connect"])
    connectCommand.set_writable()
    homeCommand = commandListNode.get_child(["0:Home"])

    myvar = commandListNode.add_variable(idx, "MyVariable", False)
    ...
    try:
        ...
        connectCopy = connectCommand.get_value()
        connectCopy = copy.copy(connectCopy)
        connectCopy = True
        connectCommand.set_value(connectCopy)
